...
<form id="createForm1" action="/hocsinh?action=create" method="post">
    <table>
        <tr>
            <th style="text-align: center" colspan="2">Creat a new student</th>
        </tr>
        <tr>
            <td>Mã Học Sinh: </td>
        ...
        <tr>
            <td>Lớp</td>
            <td><input type="text" name="nameClass" ></td>
        ...
        <form>
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"><a style="text-decoration: none;color: white" href="/hocsinh">Thoát</a></button>
                </div>
            </div>
        </form>
    </div>
